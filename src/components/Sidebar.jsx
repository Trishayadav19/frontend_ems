...
import { LayoutGridIcon, MenuIcon, UserIcon, XIcon, CalendarIcon, FileTextIcon, DollarSignIcon, SettingsIcon, ChevronRightIcon, LogOutIcon, Loader2 } from 'lucide-react'
    ...
    const siderbarContent = (
        <>
                ...
                <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <p className='text-[11px] text-slate-500 font-medium'>Management Systum</p>
                        </div>
                    </div>
            ...
            <div className='p-3 border-t border-white/6'>
                <button onClick={handlelogout} className='flex items-center gp-3 w-full px-3 py-2.5 rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150'>
