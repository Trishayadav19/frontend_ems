...
const Loginlanding = () => {
  ...
  return (
    <div className='min-h-screen flex flex-con md:flex-row'>
      <LoginLeftSide />
      ...
      <div className='w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen'>
        <div className='w-full max-w-md animate-fade-in relative z-10'>
          ...
          <div className='mb-10 text-center md:text-left'>
            <h2 className='text-3xl font-mediumtext-slate-900 tracking-tight mb-3'>Welcome Back</h2>
            ...
            {portalOptions.map((portal) => (
              <Link key={portal.to} to={portal.to}
                ...
                <div className='relative z-10 flex items-center justify-between gap-4 sm:gap-5'>
                  ...
                  <ArrowRightIcon className="w-4 h-4 tex-slate-400 group-hover:text-indigo-600 group-hover:transalte-x-1 transition-all duration-300" />
                </div>
              </Link>
            ))}
          </div>
          ...
          <div className='mt-12 text-center md:text-left text-sm text-slate-400'>
            <p>© {new Date().getFullYear()} Employee Managment Systum.</p>
          </div>
        </div>
